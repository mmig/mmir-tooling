...
var fs = require('fs'),
	...
	grammarGen = require('./../generator/standalone-grammar-gen');
...
var prepareExecTemplate = function(options){
	...
	}, options);//END: grammarGen.run(function(){...
 ...
 * 			options.debug {Boolean} OPTIONAL enable debug output
 */
