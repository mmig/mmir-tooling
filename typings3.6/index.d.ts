...
export interface GrammarBuildOptions extends GrammarOptions, BuildOptions {
    /** @override */
    grammars?: {
        [grammarId: string]: GrammarBuildEntry;
    };
}
...
export interface SettingsOptions {
    ...
    dictionary?: boolean | {
        [id: string]: SettingsEntryOptions;
    };
...
export type AsyncGramarExecEntry = {
    id: string;
    phrase: string;
};
...
export type ModuleConfig = {
    ...
    logLevel?: mmir.LogLevelNum | mmir.LogLevel;
};
...
export interface ControllerOptions extends ImplementationOption {
    ...
    path?: string;
    controllers?: boolean | {
        [id: string]: ImplementationEntry | boolean;
    };
}
/**
 * @example
...
export type PluginConfig = MediaManagerPluginEntry & {
    [config: string]: any;
};
export type PluginExportInfo = {
    ...
    dependencies: string[];
    modes?: {
        [pluginModeOption: string]: PluginExportModeEntry;
    };
     ...
     */
    getAll(type: PluginExportType, mode?: PluginModeOption | string, isResolve?: boolean): string[] | {
        [moduleId: string]: string;
    } | {
        [pluginModeOption: string]: PluginExportModeEntry;
    };
     ...
     */
    getBuildConfig(buildConfigsMap?: Set<any> | {
        [buildConfig: string]: boolean;
    } | Array<any>): PluginExportBuildConfig[];
    getBuildConfig(pluginName?: string): PluginExportBuildConfig[];
    getBuildConfig(pluginName?: string, buildConfigsMap?: Set<any> | {
        [buildConfig: string]: boolean;
    } | Array<any>): PluginExportBuildConfig[];
};
export type PluginExportType = 'paths' | 'workers' | 'modules' | 'dependencies' | 'files';
export type PluginExportModeEntry = {
    [modulePathOverrideId: string]: string;
} & {
    files?: string[];
};
...
export interface PluginExportConfigInfoMultiple {
    pluginName: string[];
    plugins: {
        [pluginId: string]: PluginExportConfigInfo;
    };
}
...
export type PluginExportBuildConfig = {
...
export interface TTSPluginSpeechConfig {
    ...
    voice?: 'male' | 'female' | string | {
        [languageCode: string]: 'male' | 'female' | string;
    };
}
